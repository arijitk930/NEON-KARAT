                    ...
                    <div>
                        ...
                        <div className="space-y-8 max-w-2xl">
                            <p className="text-2xl">
                                We <span className="font-semibold">compare your stats with anonymized data</span> from thousands of other top creators.
                            </p>
                            <p className="text-xl text-gray-600">
                                Our mission is to help creators run their businesses better. By trying our calculator, you're providing <span className="font-semibold text-black">knowledge that helps everyone.</span>
                            </p>
                        </div>
                    </div>
