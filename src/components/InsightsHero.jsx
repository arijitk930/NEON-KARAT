  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="font-primaryBold text-3xl sm:text-4xl md:text-5xl lg:text-[50px] leading-none font-black tracking-tight mb-8 sm:mb-10 md:mb-12">
          FIND OUT HOW MUCH
          <br />
          YOU CAN{" "}
          <span className="inline-flex items-center align-middle">
            <img
              className="h-16 sm:h-20 md:h-24 lg:h-28 mt-1 sm:mt-2" // Adjusted height for responsiveness
        ...
        <p className="text-base sm:text-lg md:text-xl text-gray-600 mb-8 sm:mb-10 md:mb-12 max-w-2xl md:max-w-3xl mx-auto">
        ...
        <div className="flex flex-col items-center space-y-8 sm:space-y-10 md:space-y-12">
          <div className="flex -space-x-2 sm:-space-x-3 md:-space-x-4">
            <img
              ...
              className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full border-2 sm:border-3 md:border-4 border-white object-cover"
              alt="Creator"
            />
            <img
