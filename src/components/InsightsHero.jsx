        ...
        <div className="container mx-auto px-6 py-20">
            <div className="max-w-6xl mx-auto text-center">
                <h1 className="text-[80px] leading-none font-black tracking-tight mb-12">
                    ...
                    YOU CAN <span className="inline-flex items-center">
                        <img className='h-40' src="https://cdn.prod.website-files.com/64319e85443cd280068e5fff/662b7f17bdef4adb6e8f7a08_Karat_Cash_300%20px.gif" alt="dollar sign" />
                ...
                <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
                    Karat Insights uses our real financial and social data to help creators make more money.
                </p>
