...
const TaxComponent = () => {
  return (
    <>
      <div className="bg-blue-gray-800 text-white">
        <h1 className="font-primaryBold text-4xl pt-16 ml-28">
          A CARD DESIGNED <br />
          TO HELP YOU GROW
        </h1>
        <div className="flex flex-wrap w-full items-center justify-evenly mx-auto py-8 px-4">
          ...
          <div className="w-full md:w-1/2 md:pl-8 flex flex-col justify-center text-white text-center md:text-left mb-4 md:mb-0">
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-white font-primaryBold">
                Higher limits
              </h2>
              <p className="mt-2">
                We give creators the spending power they need to power their
                growth.
              </p>
            </div>
            <div>
              <h2 className="text-2xl font-bold font-primaryBold">
                Build your credit
              </h2>
              <p className="mt-2">
                Build your personal credit history so you can get your dream
                apartment, car, or house.
              </p>
            </div>
          </div>
          {/* Right Side Image */}
      ...
      <div
        className="flex flex-wrap w-full items-center justify-evenly mx-auto py-8 px-4
             bg-blue-gray-800"
      >
        {/* Left Side Text */}
        <div className="w-full md:w-1/2 md:pl-8 flex flex-col justify-center text-white text-center md:text-left mb-4 md:mb-0">
          <div className="mb-8">
            ...
            <p className="mt-2">
              Join the VanityCard community for exclusive events with the
              biggest creators in the world.
            </p>
          </div>
          <div>
            <h2 className="text-2xl font-bold font-primaryBold">
            ...
            <p className="mt-2">
              Earn points to redeem for one-of-a-kind rewards, like having your
              face on a billboard in Times Square.
            </p>
          </div>
        </div>
        {/* Right Side Image */}
