...
const Login = () => {
    ...
    const handleGoogleSignIn =async () => {
        await service.account.createOAuth2Session('google',"http://localhost:5173","http://localhost:5173/login")
            .then(() => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const user = await service.loginUser(formData.email, formData.);
            if (user) {
